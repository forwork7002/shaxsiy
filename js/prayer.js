/* =====================================================================
   ...
   Nukus, Termiz, Farg’ona, Angren, Zarafshon, O’sh — sentyabr 2026,
...
(function () {
  ...
  const prayer = {
    ...
    places: [
      ...
      { n: 'Qo’qon', c: 'Қўқон Коканж', lat: 40.535509, lng: 70.937948 },
      { n: 'Xiva', c: 'Хива', lat: 41.389141, lng: 60.350174 },
      { n: 'Marg’ilon', c: 'Марғилон Маргилан', lat: 40.47111, lng: 71.72472 },
      ...
      { n: 'Do’stlik', c: 'Дўстлик Дустлик', lat: 40.528459, lng: 68.030412 },
      { n: 'Dushanbe', c: 'Душанбе', lat: 38.560052, lng: 68.786846 },
      { n: 'Farg’ona', c: 'Фарғона Фергана', lat: 40.376952, lng: 71.793129 },
      { n: 'G’allaorol', c: 'Ғаллаорол Галлаарал', lat: 40.665277, lng: 67.244211 },
      { n: 'G’azalkent', c: 'Ғазалкент', lat: 41.5659, lng: 69.7704 },
      { n: 'Gazli', c: 'Газли', lat: 40.12947, lng: 63.457245 },
      { n: 'G’uzor', c: 'Ғузор Гузор', lat: 38.520046, lng: 66.142491 },
      ...
      { n: 'Kattaqo’rg’on', c: 'Каттақўрғон Каттакурган', lat: 39.90129, lng: 66.269495 },
      ...
      { n: 'Oltinko’l', c: 'Олтинкўл Алтынкуль', lat: 42.772018, lng: 59.142859 },
      { n: 'O’sh', c: 'Ўш Ош', lat: 40.51524, lng: 72.815204 },
      { n: 'O’smat', c: 'Ўсмат Усмат', lat: 39.736121, lng: 67.652669 },
      ...
      { n: 'Qo’ng’irot', c: 'Қўнғирот Кунгират', lat: 43.060726, lng: 58.862514 },
      { n: 'Qorako’l', c: 'Қоракўл Каракул', lat: 39.495808, lng: 63.856634 },
      { n: 'Qo’rg’ontepa', c: 'Қўрғонтепа Кургантепа', lat: 40.731087, lng: 72.759757 },
      { n: 'Qorovulbozor', c: 'Қоровулбозор Каравулбазар', lat: 39.488766, lng: 64.759067 },
      { n: 'Qumqo’rg’on', c: 'Қумқўрғон Кумкурган', lat: 37.819965, lng: 67.599609 },
      ...
      { n: 'Taxtako’pir', c: 'Тахтакўпир Тахтакупир', lat: 43.016883, lng: 60.310256 },
      { n: 'Termiz', c: 'Термиз Термез', lat: 37.258528, lng: 67.308346 },
      { n: 'Tomdi', c: 'Томди Тамды', lat: 41.757288, lng: 64.626303 },
      { n: 'To’rtko’l', c: 'Тўрткўл Турткуль', lat: 41.549257, lng: 60.991887 },
      ...
      { n: 'Uchqo’rg’on', c: 'Учқўрғон Учкурган', lat: 41.121434, lng: 72.088502 },
      ...
      { n: 'Xo’jand', c: 'Хўжанд Ходжанд', lat: 40.2833322, lng: 69.6333308 },
      { n: 'Xo’jaobod', c: 'Хўжаобод Ходжаабад', lat: 40.666157, lng: 72.565383 },
