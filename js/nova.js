...
(function () {
  ...
  D.i18n.add({
    uz: {
      ...
      'nova.setupHint': "Nova ishlashi uchun serverda AI kaliti (OpenAI) yoki o'z API kalitingiz kerak.",
    ...
    uzk: {
      ...
      'nova.setupHint': 'Nova ишлаши учун серверда AI калити (OpenAI) ёки ўз API калитингиз керак.',
    ...
    ru: {
      ...
      'nova.setupHint': 'Для работы Nova нужен ключ AI на сервере (OpenAI) или ваш собственный API-ключ.',
