...
const CACHE = 'dash-v1';
const SHELL = [
  './', './index.html', './app.css', './css/today.css', './css/tasks.css', './css/health.css', './css/gym.css', './css/finance.css', './css/learn.css', './css/stats.css', './css/ibodat.css', './css/nova.css', './css/settings.css', './manifest.json', './icons/icon.svg',
  './js/core.js', './js/i18n.js', './js/prayer.js', './js/today.js', './js/tasks.js', './js/health.js', './js/gym.js',
