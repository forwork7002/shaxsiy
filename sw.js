...
const SHELL = [
  './', './index.html', './app.css', './css/sections.css', './css/ai.css', './css/whoop.css', './css/today.css', './css/tasks.css', './css/health.css', './css/gym.css', './css/finance.css', './css/learn.css', './css/stats.css', './css/ibodat.css', './css/nova.css', './css/settings.css', './css/history.css', './manifest.json', './icons/icon.svg',
  './js/core.js', './js/i18n.js', './js/prayer.js', './js/ai.js', './js/whoop.js', './js/today.js', './js/tasks.js', './js/health.js', './js/gym.js',
  './js/finance.js', './js/learn.js', './js/stats.js', './js/ibodat.js', './js/nova.js', './js/settings.js', './js/history.js', './js/app.js',
];
